...
# Deep SORT parameters
    ...
    nn_budget = None
    nms_max_overlap = 1
    model_filename = 'C:/Users/piyalong/Traffic Management/yolov5-master/model_data/veri.pb'
#     YOLO v5 parameters
    if torch.cuda.is_available():  
        device_id = "cuda:0" 
    else:  
        device_id = "cpu"  
    weights = "C:/Users/piyalong/TAMIDS/yolov5-master/weights/yolov5x.pt"
    img_size=imgsz=1280
    conf_thres=0.2
    iou_thres = 0.5
...
if __name__ == '__main__':
    ...
    parser.add_argument('--zreference', type=str, help='reference on the map, counter clock wise starting with upper left corner')
